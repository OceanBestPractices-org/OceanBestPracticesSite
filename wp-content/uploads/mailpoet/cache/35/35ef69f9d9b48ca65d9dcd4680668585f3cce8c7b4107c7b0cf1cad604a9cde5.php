...
class __TwigTemplate_60aca594a85ac2ae3b4002d633cf3d18bca20bb404bd71753188cad030aed77d extends \MailPoetVendor\Twig\Template
{
...
<input type=\"text\" disabled=\"disabled\" value=\"\" placeholder=\"{{#if params.label_within}}{{ params.label }}{{#if params.required}} *{{/if}}{{/if}}\" />";
    ...
    {
        return new Source("", "form/templates/blocks/text.hbs", "/var/www/obps/wp-content/plugins/mailpoet/views/form/templates/blocks/text.hbs");
    }
}
